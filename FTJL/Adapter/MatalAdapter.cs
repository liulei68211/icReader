...
namespace FTJL.Adapter
{
    public class TableItem1
    {
        ...
        public TableItem1(string samfactory, string carnumber, string goodsname)
        {
    ...
    public class MatalAdapter : BaseAdapter<TableItem1>
    {
        ...
        public MatalAdapter(Activity context, List<TableItem1> items): base()
        {
            this.items = items;
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            TableItem1 item = items[position];
            if (convertView != null)
            {
